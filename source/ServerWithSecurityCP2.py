            ...
            with client_socket:
                while True:
                    match convert_bytes_to_int(read_bytes(client_socket, 8)):
                        ...
                        case 4:
                            #TODO
                            # 1. Receive encrypted symmetric key
                            # 2. Decrypt the encrypted symmetric key

                            # 1. Received encrypted key
                            message_length = convert_bytes_to_int(read_bytes(client_socket, 8)) #m1_1
                            encrypted_session_key_bytes = read_bytes(client_socket, message_length)
                            ...
                            # message_length = convert_bytes_to_int(read_bytes(client_socket, 8))
                            # encrypted_message = read_bytes(client_socket, message_length)
                            # message = session_key.decrypt(encrypted_message)
